            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        ...
                        <a href="place_order.php?product_id=<?php echo $item['item_id'] ?? '0'; ?>&subtotal=<?php echo isset($subTotal) ? count($subTotal) : 0; ?>&total_price=<?php echo isset($subTotal) ? $Cart->getSum($subTotal) : 0; ?>" class="btn btn-primary">Place Order</a>
